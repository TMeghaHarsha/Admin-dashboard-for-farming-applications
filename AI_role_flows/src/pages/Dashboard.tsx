...
export default function Dashboard() {
  ...
  if (currentRole === "agronomist") return <AgronomistDashboard />;
  if (currentRole === "support") return <SupportDashboard />;
  if (currentRole === "business") return <BusinessDashboard />;
  if (currentRole === "analyst") return <AnalystDashboard />;
  if (currentRole === "development") return <DevelopmentDashboard />;

  // SuperAdmin and Admin use the same dashboard layout (data filtering happens in backend)
  return (
    <DashboardLayout>
